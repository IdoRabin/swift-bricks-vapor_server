...
//	== END OF CASES ==
	...
	var name : String {
		switch self {
		case .unknown:		return AppError.DEFAULT_DOMAIN
	...
	static func domain(for code:AppErrorCode)->AppErrorDomain {
		return self.domain(forIntCode: code.rawValue)
	}

	static func domain(forIntCode code:Int)->AppErrorDomain {
		switch code {
