...
extension AppErrorCode {
    ...
    var httpStatusCode : HTTPResponseStatus? {
        ...
        switch self {
            ...
            case .http_stt_unauthorized:        result = .unauthorized // MDN: 401 Response status code indicates that the client request has not been completed because it lacks valid authentication credentials for the requested resource.
            ...
            case .http_stt_networkAuthenticationRequired:  result = .networkAuthenticationRequired
            default:
                result = nil
        }
