...
class AppSettingsGlobal : MNSettingsCategory {
    @AppSettable(key:"global.newUsernameAllowedTypes", default:MNUserPIIType.allCases) var newUsernameAllowedTypes : [MNUserPIIType]
    @AppSettable(key:"global.existingAllowedTypes", default:MNUserPIIType.allCases) var existingAllowedTypes : [MNUserPIIType]
}
