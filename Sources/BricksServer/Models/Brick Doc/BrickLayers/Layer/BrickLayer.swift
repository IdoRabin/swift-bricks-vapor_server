...
final class BrickLayer : MNUIDable, CodableHashable, CustomStringConvertible {
    ...
    enum Visiblity : Int, Codable, CaseIterable {
        case hidden
        case visible
    ...
    enum Access : Int, Codable, CaseIterable {
        case locked
        case unlocked
    ...
    private (set) var creatingUserId : MNUID? // Default = nil
    ...
    convenience init(uid:BricksLayerUID? = nil, name newTitle:String? = nil) {
        self.init()
        id = uid?.uid ?? UUIDv5()
        name = newTitle
    }
